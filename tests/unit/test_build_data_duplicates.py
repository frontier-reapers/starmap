...
def _create_db_with_duplicates(path):
    ...
    cur.execute('INSERT INTO systems (solarSystemId, name, centerX, centerY, centerZ) VALUES (?, ?, 0, 0, 0)', (1, 'S1'))
    cur.execute('INSERT INTO systems (solarSystemId, name, centerX, centerY, centerZ) VALUES (?, ?, 0, 0, 0)', (1, 'S1-dup'))
    con.commit()
    con.close()
